...
class Dec07Test extends AnyFlatSpec with Matchers {
  ...
  "Part 01" should "create graph" in {
    Dec07.runChain(List(3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0), List(4, 3, 2, 1, 0))
  ...
  "Part 02" should "run in loops" in {
    Dec07.runChain(List(3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,
      27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5), List(9,8,7,6,5)).head should be(139629729)
